...
$availability_error = esc_html__( "عذرًا، لقد تم حجز هذا الموعد من قبل شخص آخر. يُرجى اختيار وقت آخر للحجز.", "booked" );
?>
...
<p class="booked-title-bar"><small><?php echo ( $new_appointment_default == 'draft' ? esc_html__('طلب موعد', 'booked') : esc_html__('حجز موعد', 'booked') ); ?></small></p>
