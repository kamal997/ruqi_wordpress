...
= 2.4.4 =
* **FIX:** Security Update: Patch for sensitive data exposure vulnerability. All calendar feeds have expired. Use new calendar feeds under Settings / Calendar Feeds.
* **FIX:** Security Update: Patch for vulnerable plugin update connection.
* **INFO:** https://quickcal.co/booked-security-update


= 2.4.3 =
* **FIX:** Security Update: Fixed Arbitrary Content Deletion issue
* **FIX:** Security Update: Fixed Cross Site Request Forgery (CSRF) issue
* **FIX:** Security Update: Fixed Information Disclosure issue

= 2.4.2 =
* **FIX:** Fixed some PHP errors related to sessions & curl responses.
